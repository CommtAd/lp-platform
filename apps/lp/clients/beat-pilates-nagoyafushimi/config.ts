...
const scheduleByDate: Record<string, number[]> = {
  ...
  // ── 9月（クライアント番号 = 固定番号） ──
  "2026-09-01": [], // 火・枠なし（休講）
  "2026-09-02": [2, 3, 7, 8, 9],
  "2026-09-03": [2, 3, 7, 8, 9],
  "2026-09-04": [4, 5, 7, 8, 9],
  "2026-09-05": [1, 2, 3, 4, 5],
  "2026-09-06": [4, 5, 6],
  "2026-09-07": [2, 3, 7, 8, 9],
  "2026-09-08": [2, 3, 7, 8, 9],
  "2026-09-09": [2, 3, 7, 8, 9],
  "2026-09-10": [1, 2, 7, 8, 9],
  "2026-09-11": [4, 5, 7, 8, 9],
  "2026-09-12": [4, 5, 6],
  "2026-09-13": [1, 2, 3, 5, 6],
  "2026-09-14": [1, 2, 7, 8, 9],
  "2026-09-15": [2, 3, 4, 5],
  "2026-09-16": [2, 3, 7, 8, 9],
  "2026-09-17": [4, 5, 7, 8, 9],
  "2026-09-18": [1, 2, 7, 8, 9],
  "2026-09-19": [2, 3, 4, 5, 6],
  "2026-09-20": [1, 2, 4, 5, 6],
  "2026-09-21": [1, 2, 4, 5, 6], // 月・敬老の日（祝）→ ⑥=17:00-17:45 は weekdaySlots[5] で描画
  "2026-09-22": [2, 3, 4, 5, 6], // 火・国民の休日（祝）→ 同上
  "2026-09-23": [1, 2, 3, 4], // 水・秋分の日（祝）
  "2026-09-24": [1, 2],
  "2026-09-25": [4, 5, 7, 8, 9],
  "2026-09-26": [2, 3, 4, 5, 6],
  "2026-09-27": [4, 5, 6],
  "2026-09-28": [2, 3],
  "2026-09-29": [4, 5, 7, 8, 9],
  "2026-09-30": [2, 3, 7, 8, 9],
  // ── 10月（クライアント番号 = 固定番号） ──
  "2026-10-01": [1, 2, 7, 8, 9],
  "2026-10-02": [4, 5, 7, 8, 9],
  "2026-10-03": [1, 2, 4, 5, 6],
  "2026-10-04": [2, 3, 4, 5, 6],
  "2026-10-05": [2, 3, 7, 8, 9],
  "2026-10-06": [2, 3, 7, 8, 9],
  "2026-10-07": [2, 3, 7, 8, 9],
  "2026-10-08": [1, 2, 7, 8, 9],
  "2026-10-09": [4, 5, 7, 8, 9],
  "2026-10-10": [2, 3, 4, 5, 6],
  "2026-10-11": [2, 3, 4, 5, 6],
  "2026-10-12": [2, 3, 4, 5, 6], // 月・スポーツの日（祝）→ ⑥=17:00-17:45 は weekdaySlots[5] で描画
  "2026-10-13": [2, 3, 4, 7, 8, 9],
  "2026-10-14": [2, 3, 7, 8, 9],
  "2026-10-15": [1, 2, 7, 8, 9],
  "2026-10-16": [4, 5, 7, 8, 9],
  "2026-10-17": [2, 3, 4, 5, 6],
  "2026-10-18": [2, 3, 4, 5, 6],
  "2026-10-19": [2, 3, 7, 8, 9],
  "2026-10-20": [4, 5, 7, 8, 9],
  "2026-10-21": [2, 3, 7, 8, 9],
  "2026-10-22": [1, 2, 7, 8, 9],
  "2026-10-23": [4, 5, 7, 8, 9],
  "2026-10-24": [2, 3, 4, 5, 6],
  "2026-10-25": [2, 3, 4, 5, 6],
  "2026-10-26": [2, 3, 7, 8, 9],
  "2026-10-27": [4, 5, 7, 8, 9],
  "2026-10-28": [2, 3, 7, 8, 9],
  "2026-10-29": [1, 2, 7, 8, 9],
  "2026-10-30": [1, 2, 7, 8, 9],
  "2026-10-31": [1, 2, 3, 4, 5, 6],
};
 ...
 */
const LAST_CONFIRMED_DATE = "2026-10-31";
...
const scheduleByDateOptions: Record<string, { value: string; label: string }[]> = Object.fromEntries(
  Object.entries(scheduleByDate).map(([iso, numbers]) => {
    const source = isWeekendDate(iso) ? weekendSlots : weekdaySlots;
    return [iso, numbers.map((n) => source[n - 1])];
  }),
);
