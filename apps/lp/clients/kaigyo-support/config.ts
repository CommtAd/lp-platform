...
const config: PatternBConfig = {
  ...
  fv: {
    badge: "ジム・ピラティス・ヨガ・整体などに対応",
    heading: ["フィットネス店舗の開業で、", "一番不安な【集客】まで成果保証。"],
    highlight: "集客できなければ広告運用費0円",
    sub: "HP・LP制作、予約システム導入、広告運用まで、\n開業時に必要なWeb・集客業務をワンストップで支援します。",
    ctaText: "無料で開業集客プランを相談する",
    trust: ["物件決定前でも相談可能", "見積り無料", "しつこい営業なし"],
    hero: {
