...
const ASSET = "/clients/the-personal-pilates";

/** Real production data for THE PERSONAL PILATES (pattern A). */
const config: PatternAConfig = {
  slug: "the-personal-pilates",
  status: "published",
  meta: {
    title: "THE PERSONAL PILATES｜国分寺・吉祥寺のマシンピラティススタジオ",
    description:
  ...
  about: {
    heading: "THE PERSONAL PILATES\nについて",
    photo: { placeholder: "スタジオ / トレーナーの写真", src: null },
    caption: "Personal × Pilates",
    lead: "鍛えるだけでも、\nただ休めるだけでもない。",
    body: "姿勢の乱れ、運動不足、抜けない疲れ。その日の身体は毎日ちがいます。THE PERSONAL PILATESは、全国50店舗以上のパーソナルジムで培った身体づくりの知見を活かし、鍛える日も整える日も、あなたのコンディションに合わせて通えるマシンピラティススタジオです。",
  },
