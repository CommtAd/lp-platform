...
export default function Page() {
  const c = config;
  const mapSrc =
    c.access.store.mapEmbed ??
    `https://maps.google.com/maps?q=${encodeURIComponent(c.access.store.mapQuery)}&output=embed`;
