...
export interface BeeConfig {
  ...
  access: {
    ...
    store: {
      ...
      route: string;
      mapQuery: string;
      /** Google マップの埋め込みURL（指定時は mapQuery より優先。店舗ピンを正確に出す用） */
      mapEmbed?: string;
    };
  };
...
const config: BeeConfig = {
  ...
  philosophy: {
    eyebrow: "CONCEPT",
    heading: "「ずっと、もっと、美しく」\nを、あなたのものに。",
    body: "ピラティスは、呼吸を使って体の深部を目覚めさせ、正しい動きを生みだすエクササイズ。体をコアから鍛え、姿勢を整え、芯から美しい身体をつくります。初めての方でも、何歳からでも、安心して始められる、プロによる一対一のサポートです。",
  },
  ...
  about: {
    ...
    body: "呼吸を使い、体の深部（コア）を目覚めさせ、正しい動きを生みだすエクササイズです。表面の筋肉ではなく、体を内側から支えるインナーマッスルに働きかけることで、身体を根本から整え、一生ものの身体づくりへと導きます。Beê では、お一人おひとりの体の状態や目標に合わせて、プロのインストラクターが一対一でレッスンを組み立てます。",
    points: [
      { icon: "spine", label: "姿勢を整える", desc: "体幹（コア）を目覚めさせ、内側からまっすぐ美しい姿勢へ。" },
      { icon: "body", label: "芯から美しい身体へ", desc: "インナーマッスルを育て、内側から引き締まった、しなやかな身体を。" },
  ...
  flow: {
    ...
    steps: [
      ...
      },
      {
        ...
        body: "体験を踏まえた通い方やプランをご案内。体験レッスン時のご入会で入会金0円の特典もございます。",
      },
    ],
  ...
  faq: {
    ...
    items: [
      ...
      {
        q: "体験レッスンのときに入会しないといけませんか？",
        a: "いいえ、その場でのご入会は必須ではありません。体験レッスンだけでも大歓迎です。無理な勧誘はいたしませんので、ご自身のペースでご検討ください（体験レッスン時にご入会いただくと入会金22,000円が0円になる特典がございます）。",
      },
      {
