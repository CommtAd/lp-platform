...
const config: SerenConfig = {
  ...
  meta: {
    ...
    description:
      "AI姿勢分析付きのマンツーマン体験レッスンが、9月30日までのご予約で完全無料（通常11,550円）。国家資格「理学療法士」が所属・監修するプログラム。錦糸町店・南行徳店。",
    /*
  ...
  fv: {
    ...
    subLines: ["AI姿勢分析で、今の身体を知る。", "50分マンツーマンで、整えていく。"],
  ...
  flow: {
    ...
    steps: [
      ...
      },
      {
        num: "2",
        title: "ご来店・受付",
        body: "AI姿勢分析のお時間を含め、開始の20分前を目安にお越しください。",
        time: "20分前",
      },
      {
        num: "3",
      ...
      },
      {
        num: "6",
        title: "結果のご説明",
        body: "身体の変化と、これからの整え方をご説明します。その場でのご入会は不要です。",
      },
    ],
  },
  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        a: "いたしません。レッスン後に身体の状態とプランをご説明しますが、その場でご入会いただく必要はありません。ご自宅でゆっくりご検討ください。",
      },
    ],
  },
  ...
  closing: {
    ...
    chips: ["初めての方限定", "AI姿勢分析付き", "マンツーマン50分", "入会金0円"],
  },
