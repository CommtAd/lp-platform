        ...
        >
          ...
          >
            {c.header.logo ? (
              <div style={{ lineHeight: 1.25 }}>
                ...
                />
                {c.header.hours && (
                  <div style={{ fontSize: 9, letterSpacing: "0.14em", color: "#3E3A31", marginTop: 4, marginLeft: 3 }}>
                    {c.header.hours}
                  </div>
                )}
              </div>
              ...
              <div style={{ lineHeight: 1.25 }}>
                ...
                <div style={{ fontSize: 9, letterSpacing: "0.14em", color: "#9C9285" }}>
                  {c.header.brandSub}
                </div>
              </div>
            )}
          ...
          <div
            style={{
              ...
              display: "flex",
              alignItems: "center",
              background: "linear-gradient(120deg, #C99A85 0%, #B87E68 55%, #A96E58 100%)",
              padding: "14px 18px",
          ...
          {/* ── ① FV ── */}
          <section style={{ position: "relative", minHeight: 560, overflow: "hidden", background: "#3B342C" }}>
            <ImageSlot
              src={c.fv.hero.src}
          ...
          <section style={{ background: "#FCFBF7", padding: "54px 24px" }}>
            <div style={{ textAlign: "center" }}>
              <div style={{ fontFamily: fontMincho, fontSize: 14, letterSpacing: "0.12em", color: "#5A5044" }}>
                {c.offer.eyebrow}
              </div>
              <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 12, marginTop: 8 }}>
                <span style={{ display: "inline-block", width: 22, height: 1, background: "linear-gradient(90deg, transparent, #C49A85)", position: "relative" }}>
                  <span style={{ position: "absolute", right: -2, top: -2, width: 4, height: 4, borderRadius: "50%", background: "#C49A85" }} />
                </span>
                <h2
                  style={{
                    fontFamily: fontMincho,
                ...
                <span style={{ display: "inline-block", width: 22, height: 1, background: "linear-gradient(90deg, #C49A85, transparent)", position: "relative" }}>
                  <span style={{ position: "absolute", left: -2, top: -2, width: 4, height: 4, borderRadius: "50%", background: "#C49A85" }} />
                </span>
              </div>
            </div>
            ...
            <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 14, marginTop: 26 }}>
              <div style={{ display: "flex", flexDirection: "column", alignItems: "flex-start", gap: 8 }}>
                <span style={{ display: "inline-flex", background: "#5A5044", color: "#FFFFFF", fontSize: 10.5, fontWeight: 700, letterSpacing: "0.02em", padding: "6px 10px", borderRadius: 4, whiteSpace: "nowrap" }}>
                  {c.offer.trialBadge}
                </span>
                <div style={{ display: "flex", alignItems: "baseline", gap: 4 }}>
                  <span style={{ fontSize: 11, color: "#6E6455" }}>通常価格</span>
                  <span style={{ position: "relative", fontFamily: fontMincho, fontSize: 19, color: "#5A5044" }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: "16px 8px", marginTop: 34 }}>
              {c.offer.items.map((label, i) => (
                ...
                >
                  <span style={{ fontSize: 12, lineHeight: 1.4, color: "#4E483C" }}>{nl(label)}</span>
            ...
            <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 14 }}>
              <div style={{ display: "flex", flexDirection: "column", alignItems: "stretch", gap: 8 }}>
                <span style={{ display: "block", textAlign: "center", background: "#5A5044", color: "#FFFFFF", fontSize: 21, fontWeight: 700, letterSpacing: "0.34em", padding: "7px 16px 7px 22px", borderRadius: 4, whiteSpace: "nowrap" }}>
                  {c.offer.joinLabel}
                </span>
                <div style={{ display: "flex", alignItems: "baseline", gap: 6, justifyContent: "center" }}>
                  <span style={{ fontSize: 12, color: "#6E6455", letterSpacing: "0.02em" }}>{c.offer.joinRegular}</span>
                  <span style={{ fontSize: 17, color: "#C49A85" }}>→</span>
                </div>
              </div>
            ...
            <div style={{ background: "#F4F0E8", borderRadius: 12, padding: "26px 20px", marginTop: 20, textAlign: "center" }}>
              <p style={{ margin: 0, fontSize: 14, color: "#4E483C", letterSpacing: "0.04em" }}>入会後は</p>
              <p style={{ margin: "6px 0 0", fontFamily: fontMincho, color: "#3B342C", lineHeight: 1 }}>
              ...
              <p style={{ margin: "8px 0 0", fontFamily: fontMincho, fontSize: 20, letterSpacing: "0.08em", color: "#3B342C" }}>
          ...
          <section style={{ background: navyGrad, padding: "54px 26px" }}>
            ...
            <div style={{ position: "relative", margin: "40px 8px 0" }}>
              ...
              <ImageSlot src={c.about.photo.src} placeholder={c.about.photo.placeholder} radius={4} objectPosition={c.about.photo.position ?? "top"} style={{ position: "relative", zIndex: 1, width: "100%", height: 300 }} />
          ...
          <section style={{ background: creamGrad, padding: "54px 26px" }}>
            ...
            <p style={{ textAlign: "center", fontFamily: fontMincho, fontWeight: 600, fontSize: 20, letterSpacing: "0.06em", margin: "34px 0 0", color: "#3B342C" }}>
              {c.worry.closingPre}
          ...
          <section style={{ background: "#FCFBF7", padding: "58px 26px 74px" }}>
            ...
            {c.reasons.items.map((item, idx) => (
              <div key={idx} style={{ marginTop: idx === 0 ? 44 : 48 }}>
                ...
                <h3 style={{ fontFamily: fontGothic, fontWeight: 700, fontSize: 18, lineHeight: 1.6, letterSpacing: "0.04em", margin: "22px 0 0", color: "#3B342C", textAlign: "center" }}>
                  {nl(item.title)}
                </h3>
                <div style={{ width: 40, height: 2, background: "#DAD5C9", margin: "12px auto 0" }} />
                <p style={{ fontSize: 13, lineHeight: 2, color: "#6E6455", margin: item.trio ? "16px 0 20px" : "16px 0 0" }}>{item.body}</p>
                {item.trio && (
                  ...
                  <div key={i} style={{ display: "flex", gap: 16 }}>
                    ...
                    <div style={{ paddingBottom: last ? 0 : 28 }}>
                      <div style={{ display: "flex", alignItems: "baseline", gap: 10, flexWrap: "wrap" }}>
                        <h3 style={{ fontFamily: fontGothic, fontWeight: 700, fontSize: 16, letterSpacing: "0.03em", margin: 0, color: "#3B342C" }}>{step.title}</h3>
                        <span style={{ fontSize: 11, color: "#9C9285" }}>{step.time}</span>
                      </div>
                      <p style={{ fontSize: 12.5, lineHeight: 1.9, color: "#6E6455", margin: "8px 0 0" }}>{step.body}</p>
                    </div>
                  </div>
                );
              })}
              ...
              {c.access.stores.map((store, i) => (
                <div key={i} style={{ background: "#FCFBF7", borderRadius: 16, overflow: "hidden", boxShadow: "0 6px 16px rgba(70,72,60,0.10)" }}>
                  ...
                  <div style={{ padding: 20 }}>
                    <h3 style={{ fontFamily: fontGothic, fontWeight: 700, fontSize: 17, letterSpacing: "0.05em", margin: 0, color: "#3B342C" }}>{store.name}</h3>
                    <p style={{ fontSize: 12, lineHeight: 1.9, color: "#6E6455", margin: "8px 0 0" }}>
                      {store.address}
                      <br />
      ...
      <StickyFooterCTA
        ...
        offers={c.sticky.offers.map((o) => (
          <span key={o.label} style={{ display: "flex", alignItems: "baseline", gap: 5 }}>
            <span style={{ fontSize: 11, color: "#6E6455", letterSpacing: "0.02em" }}>{o.label}</span>
            <span style={{ fontFamily: fontMincho, fontWeight: 700, fontSize: 17, lineHeight: 1, color: "#BE8B72" }}>{o.value}</span>
          </span>
        ))}
      />
    </LPShell>
