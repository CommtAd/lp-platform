...
const config: SoeluConfig = {
  ...
  campaign: {
    ...
    notes: [
      ...
      "※キャンペーン適用後の月額会費はプランによって異なります。詳しくは店舗までお問い合わせください。",
  ...
  faq: {
    ...
    items: [
      ...
      {
        q: "料金プランや契約について知りたい",
        a: "料金プランは体験当日にスタッフより詳しくご案内します。当日のご入会でキャンペーン特典が適用されます。キャンペーンでのご入会は入会から12ヶ月間の在籍が条件となりますが、解約金22,000円（税込）をお支払いいただくことで即時解約も可能です。キャンペーンを適用せずにご入会された場合は、在籍条件の縛りなくご利用いただけます。プラン別の月額会費・施設維持費など詳しい料金は店舗までお問い合わせください。",
      },
    ],
  },
