  ...
  reasons: {
    ...
    items: [
      ...
      },
      {
        ...
        img: {
          // AUN No.31 と同趣旨で「ピラティスをしている画像」へ差し替え（顧客指示）。
          // MVの動画と同じ撮影素材から、リフォーマー上でブリッジをしている場面（5.0秒地点）を切り出したもの。
          // この動画はカット間が長めのクロスディゾルブでつながっており、切り替え中のフレームは
          // 別カットが重なって写る。4.6〜5.5秒がこのカットの重なりのない区間。
          placeholder: "リフォーマーでレッスンを受けている様子",
          src: `${ASSET}/reason-4.jpg`,
          // 横長の枠には元画像の高さの39%しか映らない。既定の center だと下端が
          // ちょうど頭と腕のラインを横切り、人物が切れて見えた。下に振って、
          // 上げた足からマット上の腕・頭まで全部入る位置にしている。
          position: "center 60%",
        },
      },
    ],
