...
const config: SoeluTestConfig = {
  ...
  worry: {
    ...
    items: [
      ...
      { text: "姿勢のゆがみが気になってきた", highlight: "姿勢のゆがみ" },
  ...
  future: {
    ...
    items: [
      ...
      },
      {
        ...
        title: "ととのった心と睡眠",
        body: "呼吸に集中する時間が、\n一日の緊張をほどいていきます。",
        img: { placeholder: "眠っている女性の写真", src: `${ASSET}/future-04.jpg` },
      },
    ],
    ...
    items: [
      {
        num: "01",
        title: "プロ監修の動画レッスン×\nスタッフのサポート",
        body: "レッスンはプロインストラクター監修の動画に沿って進むので、担当者による指導の差が出ません。細かなフォームの調整は、スタジオのスタッフが直接お声がけしてサポートします。",
      ...
      },
      {
        num: "02",
        title: "ピラティスとよもぎ蒸しの\n贅沢なトータルケア",
        body: "体を動かして引き締めたあとは、よもぎの蒸気でじんわり温まる時間を。運動と温活のトータルケアが、ひとつのスタジオ・ひとつの月会費で完結します。",
  ...
  plans: {
    ...
    notes: [
      "※1 2026年6月時点。",
      "※2 自社調べ・2025年10月27日〜11月12日実施の当スタジオ会員1,095名アンケート結果より。",
      "※3 ピラティス4プラン（税込 月額9,878円）を30日換算した場合の、1日あたりの目安価格です。",
      "※4 受け放題の「プレミアムプラン」は月額会費 税込13,178円です。",
